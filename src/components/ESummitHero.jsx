    ...
    <div className="min-h-screen bg-gradient-to-b from-emerald-900 to-black p-8 text-white">
      ...
      >
        ...
        <div className="flex items-center">
          <img
            src="https://www.ecellvitbhopal.in/static/media/ecell-logo-dark.7485553736759fd6ade8.png"
            alt="E-Cell Logo for Entrepreneurship Summit 2025"
        ...
        <ul
          ...
          } md:flex flex-col md:flex-row md:space-x-6 text-lg absolute md:static bg-emerald-900 md:bg-transparent top-16 left-0 w-full md:w-auto py-4 md:py-0 shadow-lg md:shadow-none rounded-lg md:rounded-none`}
        >
      ...
      {/* Hero Section */}
      <div className="flex flex-col items-center justify-center text-center h-[85vh] space-y-6">
        <h1 className="text-4xl md:text-6xl font-extrabold tracking-wide animate-pulse text-white">
          E-Summit'25
        </h1>
